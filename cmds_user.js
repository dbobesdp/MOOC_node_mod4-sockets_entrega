...
exports.help = (rl) => 
  rl.log(
    `\r  Commands (params are requested after):
    \r> h              ## show help
    \r>
    \r> lu | ul | u    ## users: list all
    \r> cu | uc        ## user: create
    \r> ru | ur | r    ## user: read (show age)
    \r> uu             ## user: update
    \r> du | ud        ## user: delete
    \r>
    \r> lq | ql | q    ## quizzes: list all
    \r> cq | qc        ## quiz: create
    \r> tq | qt | t    ## quiz: test (play)
    \r> uq | qu        ## quiz: update
    \r> dq | qd        ## quiz: delete
    \r>
    \r> lf | fl | f    ## favourites: list all
    \r> cf | fc        ## favourite: create
    \r> df | fd        ## favourite: delete
    \r>
    \r> e              ## exit & return to shell`
  )
